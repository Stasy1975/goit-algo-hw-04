...
1 завдання. Загалом правильно. Тільки не треба було переводити зарплату в  int.  Якщо явно не сказано, що будуть цілі числа,  то краще використати  float. Будьте обережні з перетворенням типів - це завжи місце для потенційної помилки.    

2 завдання. Правильно. 

3 завдання.  Правильно. Ви гарно впорались із рекурсивною функцією. 

4 завдання.  Без нарікань. 
